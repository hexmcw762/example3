	...
	<form action="updatePro" method="post" name="wForm">
		<table border="1">
			...
			<tbody>
				...
				<td><input name="subject" value="${dto.subject}" required="required"
					 size="50" >
				...
				<tr><th style="width:30%">글내용</th>
					<td><textarea rows="15" cols="50" name="content" required="required" >${dto.content}</textarea></td>
				</tr>
				<tr><th style="width:30%">이메일</th>
					<td><input type="email" name="email" value="${dto.email}" required="required" size="50"></td>
				</tr>
				<tr><th style="width:30%">비밀번호</th>
					<td><input type="password" name="passwd" value="${dto.passwd}" required="required" size="50"></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
